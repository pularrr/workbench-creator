...
const COMMON_TOOLS = [
  ...
  'wb_get_resume_state', 'wb_resume_project', 'wb_unbind_project',
  'wb_list_archived_projects',
]

const STAGE_TOOLS = {
  design: [
    'wb_list_plugins', 'wb_create_project', 'wb_restore_archived_project',
  ...
  write: [
    'wb_create_project', 'wb_delete_project', 'wb_set_outline',
    'wb_set_manuscript', 'wb_set_domain_fields', 'wb_add_material',
    'wb_import_material_file', 'wb_search_materials', 'wb_bind_evidence',
  ...
  review: [
    ...
    'wb_list_export_formats', 'wb_get_run', 'wb_list_templates',
